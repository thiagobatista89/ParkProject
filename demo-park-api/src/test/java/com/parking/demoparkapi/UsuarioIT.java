...
public class UsuarioIT {
    ...
    public void createUsuario_ComUsernameRepetido_RetornarErrorMessageComStatus409() {
        ErrorMessage responseBody = testClient
                ...
                .uri("/api/v1/usuarios")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioCreateDto("admin@email.com", "123456"))
                .exchange()
    ...
    public void buscarUsuario_ComIdExistente_RetornarUsuarioComStatus200() {
        ...
        org.assertj.core.api.Assertions.assertThat(responseBody.getUsername()).isEqualTo("2@email.com");
        org.assertj.core.api.Assertions.assertThat(responseBody.getRole()).isEqualTo("CLIENTE");

        responseBody = testClient
                .get()
                .uri("/api/v1/usuarios/101")
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "2@email.com", "123456"))
                .exchange()
                .expectStatus().isOk()
                .expectBody(UsuarioResponseDto.class)
                .returnResult().getResponseBody();
    ...
    @Test
    public void buscarUsuario_ComUsuarioClienteBuscandoUsuarioCliente_RetornarErrorMessageComStatus403() {
        ErrorMessage responseBody = testClient
                .get()
